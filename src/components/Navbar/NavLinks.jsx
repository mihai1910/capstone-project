    ...
    export const NavLinks = ({open}) => { 
        return(
            ...
            `${open ? 'flex' : 'hidden'}
             flex flex-col  justify-start items-center md:justify-between absolute md:flex md:flex-row md:static 
             ...
             px-5 gap-5 md:gap-0 md:my-0`}>
                ...
                <li className='navlinks'><NavLink to='/reservations'>Reservations</NavLink></li>
